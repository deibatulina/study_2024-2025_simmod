---
## Front matter
title: "Сети Петри — Простой протокол"
...
Промежуточное состояние: следующий посылаемый пакет (NextSend) [@1].
Зададим декларации модели (рис. @fig:001).

![Задание деклараций](image/1.png){#fig:001 width=80%}
...
Сформируем начало графа пространства состояний, так как их много(рис. @fig:009):

![Пространство состояний для модели простого протокола передачи данных](image/9.png){#fig:009 width=80%}
